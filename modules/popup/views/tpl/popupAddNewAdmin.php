	...
	<div class="supsystic-item supsystic-panel">
		<h3 style="line-height: 30px;">
			<?php if($this->changeFor) {
				printf(__('Change Template to any other from list below or <a class="button" href="%s">return to Pop-Up edit</a>', PPS_LANG_CODE), $this->editLink);
			} else {
		...
		<div id="containerWrapper" style="width: 90%; margin: 40px auto;">
			...
			<div  class="popup-list">
				<?php foreach($this->list as $popup) { ?>
					<div class="popup-list-item preset" data-id="<?php echo $popup['id']?>">
						<?php /*?><a href="#" class="ppsCreatePopupFromTplBtn"><?php */?>
